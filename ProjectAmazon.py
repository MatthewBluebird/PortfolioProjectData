...
def send_mail():
    ...
    server.ehlo()
    server.login('vlad.atapov25@gmail.com', 'vlkc rgey pxac duba')  # Use the generated app password here
    ...
    server.sendmail(
        'vlad.atapov25@gmail.com',  # Sender's email address
        'vlad.atapov25@gmail.com',  # Recipient's email address
        msg  # The message
    )
